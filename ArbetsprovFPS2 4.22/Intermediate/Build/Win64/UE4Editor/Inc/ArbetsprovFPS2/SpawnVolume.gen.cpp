...
#include "ArbetsprovFPS2/SpawnVolume.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	ARBETSPROVFPS2_API UClass* Z_Construct_UClass_ASpawnVolume_NoRegister();
	ARBETSPROVFPS2_API UClass* Z_Construct_UClass_ASpawnVolume();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_ArbetsprovFPS2();
	ARBETSPROVFPS2_API UFunction* Z_Construct_UFunction_ASpawnVolume_GetRandomPointInVolume();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpawnVolume_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpawnVolume_GetRandomPointInVolume, "GetRandomPointInVolume" }, // 2829784576
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnVolume_Statics::NewProp_WhereToSpawn_MetaData[] = {
		...
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
		{ "ToolTip", "Spawn area where object will spawn" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpawnVolume_Statics::NewProp_WhatToSpawn_MetaData[] = {
		{ "Category", "Spawning" },
		{ "ModuleRelativePath", "SpawnVolume.h" },
		{ "ToolTip", "This is the object to spawn" },
	};
#endif
	...
	IMPLEMENT_CLASS(ASpawnVolume, 3421907966);
	template<> ARBETSPROVFPS2_API UClass* StaticClass<ASpawnVolume>()
	{
		return ASpawnVolume::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASpawnVolume(Z_Construct_UClass_ASpawnVolume, &ASpawnVolume::StaticClass, TEXT("/Script/ArbetsprovFPS2"), TEXT("ASpawnVolume"), false, nullptr, nullptr, nullptr);
